   ...
   <div class="row">
      <div class="col-md-12" style="padding:0;">
         <article class="topBanner">
            ...
            <h2 class="bannerTitle">"스페이스 클라우드 제휴 모임 공간"</h2>
				...
				<c:forEach items="${requestScope.list }" var="item"
					...
					<li class="filter">
						<a href="${item.linkUrl }" target="_blank">
							...
							<div class="tagArea">
								<span class="btn tag">#${fn:split(item.tags, "#")[0] }</span> 
								<span class="btn tag">#${fn:split(item.tags, "#")[1] }</span>
								<span class="btn tag">#${fn:split(item.tags, "#")[2] }</span>
							</div>
							<div class="infoArea">
								<p class="title_1">${item.title }</p>
